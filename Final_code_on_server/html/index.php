...
<body >
  <div id="particles-js" style="background-color:#E24D53;">



           <div class="container-fluid-nopadding" style="background-color:#E24D53;" id="about">
                <div class="row">
                  <div class="col-sm-4"></div>
                  <div class="col-sm-4">
                      <h1 style="text-align:center"> CMAM x CFG</h1>
                      <img src="save-the-children-png.png" width="50%" class="center-block">
                  </div>
                  <div class="col-sm-4"></div>
                </div>
           ...
           <div class="container-fluid" style="background-color:#E24D53;">
                <div class="row">
                  <div class="col-sm-4">
                     
                  </div>
                  <div class="col-sm-4">
                    <h2 > <a href="mainServer/admissions.php" style="padding-left:150px; color:white;"> Admissions </a> </h2>
                    <h2 > <a href="mainServer/discharges.php" style="padding-left:150px ;color:white;"> Discharges </a> </h2>
                    <h2 > <a href="mainServer/performance.php" style="padding-left:150px ;color:white;"> Performance </a> </h2>
                  </div>
                     <div class="col-sm-4">
        ...
        <script type="text/javascript"> particlesJS();
